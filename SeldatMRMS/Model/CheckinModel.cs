...
{
    public partial class CheckinModel : Form
    {
        public CheckinModel()
        {
            InitializeComponent();
        ...
        public CheckinModel(MainWindow content, String type)
        {
            InitializeComponent();
            props.area = "0";
            ...
            {
                bmp = new BitmapImage(new Uri(m_exePath + "//Resources//phat_checkin.png"));
                props.TypeName = "CHECKIN";
            }
            img.Source = this.bmp;
            plabel.Width = 50;
        ...
        public void setCheckinNAME(String name)
        {
        ...
        public const int TYPE_STATION_CHECKIN = 100;
        ...
        public void setCheckin(double x, double y)
        {
        ...
        private void CheckinModel_FormClosed(object sender, FormClosedEventArgs e)
        {
            this.Hide();
        }
        ...
        {
            props.NameID = getCheckinNAME();
            props.label = getCheckinLB();
